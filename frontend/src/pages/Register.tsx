...
import { User, Mail, Lock, IdCard, Store, EyeOff, Eye } from "lucide-react"
...
function Register() {
  ...
  const onSubmit = async (data: RegisterFormInputs) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : "การลงทะเบียนล้มเหลว กรุณาลองอีกครั้ง"
      ...
      <div className="space-y-6">
        ...
        {registerSuccess && (
          <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-md">
            <p className="text-emerald-700 text-sm font-medium">ลงทะเบียนสำเร็จ! กำลังนำคุณไปยังหน้าเข้าสู่ระบบ...</p>
          </div>
        )}
